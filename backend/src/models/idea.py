...
class IdeaTagLink(SQLModel, table=True):
    idea_id: Optional[UUID] = Field(default=None, foreign_key="idea.id", primary_key=True)
...
class Idea(SQLModel, table=True):
    ...
    updated_at: datetime = Field(default_factory=get_current_time, sa_column_kwargs={"onupdate": get_current_time})
    ...
    link_metadata_id: Optional[UUID] = Field(default=None, foreign_key="linkmetadata.id")
